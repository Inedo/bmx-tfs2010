...
{
    internal sealed class Tfs2010IssueTrackingProviderEditor : ProviderEditorBase
    {
...
@"var onAuthorizationChange = function(){
    ...
    $('#" + ddlAuthentication.ClientID + @"').change(onAuthorizationChange);");
        ...
        public override void BindToForm(ProviderBase extension)
        {
            ...
            var provider = (Tfs2010IssueTrackingProvider)extension;
        ...
        public override ProviderBase CreateFromForm()
        {
            ...
            var provider = new Tfs2010IssueTrackingProvider();
